...
package cactus.common.tools.dnd
{
	...
	public class DragAndDropEvent extends Event
	{
		...
		private var dragInitiator:IDragable;
		private var sourceData:SourceData;
		private var mousePos:IntPoint;
		private var targetComponent:IDropable
		private var relatedTargetComponent:IDropable;
		 ...
		 */
		public function DragAndDropEvent(type:String,dragInitiator:IDragable,sourceData:SourceData,mousePos:IntPoint,targetComponent:IDropable=null,relatedTargetComponent:IDropable=null)
		{
		 ...
		 */
		public function getDragInitiator():IDragable
		{
		 ...
		 * </p>
		 */
		public function getTargetComponent():IDropable
		{
		 ...
		 * </p>
		 */
		public function getRelatedTargetComponent():IDropable
		{
