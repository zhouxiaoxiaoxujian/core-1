package cactus.common.tools.util
{
	...
	public class NumberFormat
	{
		 ...
		 *
		 */
		public static function msToTimeString(ms:int):String
		{
			var tSecond:int = ms / 1000;
			var tMinite:int = tSecond / 60;
			var tHour:int = tMinite / 60;

			var second:int = tSecond % 60;
			var minite:int = tMinite % 60;
			var hour:int = tHour;

			var secondStr:String = (second < 10) ? "0" + second.toString() : second.toString();
			var miniteStr:String = (minite < 10) ? "0" + minite.toString() : minite.toString();
